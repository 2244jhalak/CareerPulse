...
const JobDetails = () => {
    ...
    console.log(job);
    const {_id,Name,Title,Date,Deadline,Salary,Applicants,Image,email,Description} = job;
  ...
  <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
    ...
    <form>
        ...
        <div className="flex justify-end mt-6">
            <input className="py-2.5 text-center cursor-pointer leading-5 text-white transition-colors duration-300 transform bg-gray-700 rounded-md hover:bg-gray-600 focus:outline-none focus:bg-gray-600" value="Submit"/>
        </div>
    </form>
</section>
    <div className="modal-action">
      <form method="dialog">
        ...
        <div className="flex items-center justify-center w-full h-96 lg:w-1/2">
            <img className="object-cover w-full h-full max-w-2xl rounded-md" src={Image} alt="glasses photo"/>
        </div>
    </div>
